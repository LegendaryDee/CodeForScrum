...
public class VocabExerciseTest {
    ...
    public void testExerciseAttributes() {
        assertEquals(exerciseId, vocabExercise.getExerciseID());
        assertEquals(type, vocabExercise.getType());
        assertEquals(difficulty, vocabExercise.getDifficulty());
        assertEquals(content, vocabExercise.getContent());
        assertNotNull(vocabExercise.getQuestions());
